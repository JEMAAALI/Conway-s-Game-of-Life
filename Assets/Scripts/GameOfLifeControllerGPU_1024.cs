...
public class GameOfLifeControllerGPU_1024 : MonoBehaviour
{
    ...
    private void RunComputeShader()
    {
        ...
        gameOfLifeCompute.Dispatch(kernelHandle, textureSize / 8, textureSize / 8, 1);
    }
    ...
    private void InitializeRandomState(RenderTexture texture)
    {
        ...
        randomTexture.Apply();
        //Graphics.Blit: copy the contents of randomTexture into texture 
